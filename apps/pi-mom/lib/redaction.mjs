...
function findSuspiciousStreamingSuffixIndex(text) {
  ...
  const patterns = [
    /(?:x|xo|xox[baprs]?|xapp-?|xoxe[.-]?|sk(?:-pro?j?)?|-pro?j?-[A-Za-z0-9._-]*|gh[pousr]?_?|AIza[0-9A-Za-z_-]*|lin(?:_api?)?_?|bu_?|apify_api_?)[A-Za-z0-9._=-]*$/i,
...
export function redactSensitiveText(text = "") {
  return String(text || "")
    ...
    .replace(/apify_api_[A-Za-z0-9._=-]+/gi, "apify_api_[REDACTED]")
